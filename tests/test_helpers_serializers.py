...
class BookSerializer(ModelSerializer):
    class Meta:
        ...
        fields = ("id", "name", "author", "chapters")
...
class PersonSerializer(ModelSerializer):
    ...
    class Meta:
        ...
        fields = ("id", "first_name", "last_name", "name", "partner", "children")
...
class SerializerHelperTests(TestCase):
    ...
    def test_might_have_changes_returns_false(self):
        ...
        serializer = PersonSerializer(
            justin, data={"first_name": "Justin", "last_name": "Trudeau", "partner": ""}
        )
    ...
    def test_might_have_changes_returns_true(self):
        ...
        serializer = PersonSerializer(
            justin,
            data={"first_name": "Justin", "last_name": "Trudeau2", "partner": ""},
        )
    ...
    def test_get_diff_data_for_new_object(self):
        serializer = PersonSerializer(
            data={"first_name": "Justin", "last_name": "Trudeau", "partner": ""}
        )
    ...
    def test_get_diff_data_for_exisiting_object_with_changes(self):
        ...
        serializer = PersonSerializer(
            justin,
            data={"first_name": "Justin", "last_name": "Trudeau 2", "partner": ""},
        )
